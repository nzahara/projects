...
public class UniformCostSearch {
	...
	public static <T> void main(String[] args) {
		...
		Node<T> elementFound = uniformCostSearch("G");
		System.out.println("Element Found :" + elementFound + " :" + elementFound.getValue() + ":"
				+ elementFound.getTotalPathCost());
	}

	/**
	 * The function chooses the least path cost child and expand. Also if the node
	 * is already in visited and has more path cost than the current , move the node
	 * to queue and update the path cost.
	 * 
	 * @param data
	 * @return
	 */
